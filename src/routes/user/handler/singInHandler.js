...
const { savePersonAndUser, validateEmail, validateUsername } = require('../../../service/userService');
...
const signIn = async (req, res) => {
    ...
    const user = req.body;
        ...
        const template = nunjucks.render('src/templates/userRegistration.html',{ username: newUser.username });
